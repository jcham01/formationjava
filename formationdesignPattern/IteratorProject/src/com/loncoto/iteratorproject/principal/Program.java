...
public class Program {
	...
	public static void main(String[] args) {
		...
		IPInterval ipi1 = new IPInterval(192, 100, 100, 50, 192, 100, 101, 25);
		...
		for (Integer[] ip : ipi1) { 
			System.out.println("1er parcour " + Arrays.toString(ip));
			/*for (Integer[] ip2 : ipi1) {
				System.out.println("2eme parcour " +Arrays.toString(ip2));
			}*/
		}
