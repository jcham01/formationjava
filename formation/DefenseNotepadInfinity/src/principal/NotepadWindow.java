...
public class NotepadWindow extends JFrame implements ActionListener, DocumentListener
{
	...
	public NotepadWindow() {
		...
		champFileName.getDocument().addDocumentListener(this);
		champFileName.setText("src/principal/NotepadWindow.java");
